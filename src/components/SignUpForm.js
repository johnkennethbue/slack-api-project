  ...
  const signUpFormSubmit = (data) => {
    ...
    axios({
      ...
      .catch((error) => {
        ...
        Swal.fire(
          "Invalid password/does not match, or Email already exists.",
          "Please check your Email or use another one, and check your password if it is a match (Minimum 6 characters).",
          "error"
        );
                ...
                <div>
                  ...
                  <div className="flex flex-col justify-center items-center">
                    <input
                      ...
                      className="w-full mt-4 content-center text-base px-4 py-2 border-b-2 rounded-xl border-gray-500 focus:outline-none focus:border-pink-600"
                      type="email"
                    ...
                    <div className="flex flex-row justify-end items-end mt-12 ml-48 mr-4 space-x-3.5">
                      ...
                      <button
                        className="text-sm w-full border-2 border-black px-4 py-2"
